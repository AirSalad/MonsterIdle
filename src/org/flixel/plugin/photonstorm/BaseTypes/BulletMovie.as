...
package org.flixel.plugin.photonstorm.BaseTypes 
{
	...
	public class BulletMovie extends FlxMovieClip
	{
		protected var weapon:FlxMovieWeapon;
		...
		public var _damage:uint;
		
		protected var animated:Boolean;
		
		public function BulletMovie(weapon:FlxMovieWeapon, id:uint)
		{
			super(0, 0);

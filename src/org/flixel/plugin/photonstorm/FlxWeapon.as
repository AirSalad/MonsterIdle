...
package org.flixel.plugin.photonstorm 
{
	...
	public class FlxWeapon extends FlxObject
	{
		/**
		...
		/*public function makeMovieBullet(quantity:uint, movie:MovieClip, offsetX:int = 0, offsetY:int = 0, autoRotate:Boolean = false, rotations:uint = 16, frame:int = -1, antiAliasing:Boolean = false, autoBuffer:Boolean = false):void
		{
			//bulletType == "Movie";
			group = new FlxGroup(quantity);
			...
			for (var b:uint = 0; b < quantity; b++)
			{
				...
				{
					tempBullet.loadMovieClip(movie, 20, 20);
				//}
